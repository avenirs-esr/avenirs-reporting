...
- #2076 - [Bug] Message d'erreur absent lors de la mise à jour simultanée d'une demande de feedback
- #2088 - [Bug]: [FE] Mauvaise utilisation des parameters dans `ActivityFeedbackNotificationCard`
...
- #365 - Associer des compétences déclarées et des traces à une expérience déclarée lors de son ajout
...
- #1089 - Associer une trace à une expérience déclarée depuis le détail d’une expérience déclarée
- #1090 - Associer une compétence déclarée à une expérience déclarée depuis le détail d’une expérience déclarée
- #1091 - Supprimer une ou plusieurs association(s) d'une expérience déclarée
